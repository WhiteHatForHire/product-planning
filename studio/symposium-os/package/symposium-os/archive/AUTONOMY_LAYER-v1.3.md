...
> **INTERNAL HISTORICAL MATERIAL.** This file is preserved verbatim from canonical v1.3, prior to the v2.1 generalization pass that stripped operator-specific names and project-specific references. It contains language and conventions that do not match current canonical practice. Read only for archival reference. Do not publish or share externally without redaction.
